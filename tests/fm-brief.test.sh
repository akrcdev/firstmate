...
test_secondmate_directory_paths_are_absolute_and_output_is_stable() {
  ...
  assert_grep "'$ROOT/bin/fm-status-append.sh' '$home/state/relative-home.status'" "$brief" \
  ...
  assert_grep "'$ROOT/bin/fm-status-append.sh' '$state_override/relative-state.status'" "$brief" \
  ...
  assert_grep "'$ROOT/bin/fm-status-append.sh' '$home/state/relative-data.status'" "$brief" \
